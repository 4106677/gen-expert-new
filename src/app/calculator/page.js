...
export default function Calculator () {
	...
	return (
		<>
			<GreenBox text={t('menu.calculate')}/>
			<div className={`${styles.main} container`}>
				<div className={styles.title}>
					<h1 className={styles.title_header}>{t("calculator.title")}</h1>
					<h2 className={styles.title_description}>{t("calculator.subtitle")}</h2>
				</div>
						...
						<ul className={styles.sliderList}>
							<li className={styles.sliderList_item}>
								<div className={styles.categoryTop}>
									<h4 className={styles.categoryTop_header}>{t("calculator.params.elecProd")}</h4>
									<input
							...
							<li className={styles.sliderList_item}>
								<div className={styles.categoryTop}>
									<h4 className={styles.categoryTop_header}>{t("calculator.params.elecPrice")}</h4>
									<input
										className={styles.sliderList_input}
										type="number"
										name="elecPrice"
							...
							<li className={styles.sliderList_item}>
								<div className={styles.categoryTop}>
									<h4 className={styles.categoryTop_header}>{t("calculator.params.gasPrice")}</h4>
									<input
										className={styles.sliderList_input}
										type="number"
										name="gasPrice"
							...
							<li className={`${styles.sliderList_item} ${chp ? '' : styles.sliderList_item_disable}`}>
								<div className={styles.categoryTop}>
									<h4 className={styles.categoryTop_header}>{t("calculator.params.hourlyHeat")}</h4>
									<input
								...
								<div className={styles.slider_wrapper}>
									<Slider
										...
										allowCross={false}
										styles={{
											rail: {backgroundColor: chp ? '' : '#F6F6F6'},
											track: {backgroundColor: chp ? '' : '#F6F6F6'},
											handle: {borderColor: chp ? '' : '#F6F6F6'},
										}}
									/>
									<div className={styles.slider_stint}>
							...
							<li className={`${styles.sliderList_item} ${chp ? "" : styles.sliderList_item_disable}`}>
								<div className={styles.categoryTop}>
									<h4 className={styles.categoryTop_header}>{t("calculator.params.yearlyHeat")}</h4>
									<input
										className={`${styles.sliderList_item_input} ${styles.sliderList_input}`}
										type="number"
										name="yearlyHeat"
